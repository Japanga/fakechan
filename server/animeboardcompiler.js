...
// Replace with your actual Cloudinary API secret and regular key, ours is not provided here for obvious security reasons and this is only for scientific and educational use.
cloudinary.config({
...
async function getImageGridHtml() {
  try {
    ...
    const result = await cloudinary.search
      ...
      .expression('tags:anime_uploads') // Fetch all images
